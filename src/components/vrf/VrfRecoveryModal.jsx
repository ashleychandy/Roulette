...
const VrfRecoveryModal = ({ isOpen, onClose }) => {
  ...
  // Check if gameStatus is null or undefined (which would be the case for new users)
  const hasNoGameData = !gameStatus;
          ...
          <div className="text-center mb-6">
            {hasNoGameData ? (
              <p className="text-gray-600 mt-2">
                No game data found. You haven't placed any bets yet.
              </p>
            ) : !gameStatus?.isActive ? (
              <p className="text-gray-600 mt-2">
              ...
              <p className="text-gray-600 mt-2">
                Your bet can now be recovered. You can safely recover your
                tokens.
              </p>
            ) : (
              <p className="text-gray-600 mt-2">
                Your bet is still being processed. Recovery becomes available
