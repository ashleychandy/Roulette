...
import { isRed } from "../constants/roulette_constants";

/**
 * Custom hook for handling roulette visual helper functions
 * @returns {Object} Visual helper functions
 */
export const useRouletteVisuals = () => {
